...
const apps = [
  ...
  // === AGENTS IA (outils de l'équipage des six Lois) ===
  {
    id: 'wa-router',
    name: 'Wa Router',
    description: 'Orchestrez des requêtes complexes vers l\'équipage des six Lois.',
    icon: '🎯',
    category: 'agents',
    route: '/apps/agent/wa',
  ...
  },
  {
    ...
    icon: '🛡️',
    category: 'agents',
    route: '/apps/agent/makoto',
    tags: ['Sécurité', 'Audit', 'CVE'],
    featured: true,
    isNew: true
  },
  {
  ...
  },
  {
    ...
    icon: '🚀',
    category: 'agents',
    route: '/apps/agent/jitsu',
    tags: ['CI/CD', 'DevOps', 'Pipeline'],
    featured: true,
    isNew: true
  },
  // === OUTILS NEUTRES (hors section Agents) ===
  {
